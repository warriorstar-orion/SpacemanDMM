...
use ast_proto_rust::ast::VarValue as VarValueProto;
use ast_proto_rust::ast::TreePath as TreePathProto;
use ast_proto_rust::ast::Graph as GraphProto;
use ast_proto_rust::ast::Type as TypeProto;
use ast_proto_rust::ast::TypeVar as TypeVarProto;
use ast_proto_rust::ast::TypeProc as TypeProcProto;
use ast_proto_rust::ast::ProcValue as ProcValueProto;
use ast_proto_rust::ast::Code as CodeProto;
use ast_proto_rust::ast::SymbolId as SymbolIdProto;
use ast_proto_rust::ast::ProcDeclaration as ProcDeclarationProto;
use ast_proto_rust::ast::VarDeclaration as VarDeclarationProto;
